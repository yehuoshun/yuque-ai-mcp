 ...
 */
export async function listRepoGroups() {
    ...
    if (!cookie || !ctoken) {
        return JSON.stringify({
            ...
            message: "repo_groups 需要 Cookie 登录态。请在 config/yuque-config.json 中配置 cookie 和 ctoken。",
        });
    }
...
//# sourceMappingURL=repo-groups.js.map