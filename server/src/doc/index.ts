...
export const docTools: McpTool[] = [docList, docCreate, docGet, docUpdate, docDelete, docVersions, docVersionDetail, docEmbedUrl, docBatchGet, docExportSingle, docImport];