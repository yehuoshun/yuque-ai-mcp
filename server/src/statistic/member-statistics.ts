...
export const memberStatistics: McpTool = {
  ...
  description: "Get group member statistics (supports name filter, date range, sortField/sortOrder, limit ≤ 20)",

  inputSchema: {
    type: "object",
    properties: {
      login: { type: "string", description: "Group login or ID (required)" },
      name: { type: "string", description: "Filter by member name" },
      ...
      sortField: { type: "string", description: "Sort field: write_doc_count, write_count, read_count, like_count" },
