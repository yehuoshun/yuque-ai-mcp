...
export const searchRag: McpTool = {
  ...
  description:
    "RAG-enhanced search: accepts LLM-generated keywords, runs concurrent multi-path searches across Yuque, " +
    "deduplicates by doc_id, fetches top-N full document content. " +
    "Keywords are generated by the calling LLM; document content is summarized by the calling LLM.",
  inputSchema: {
    type: "object",
    properties: {
      keywords: {
