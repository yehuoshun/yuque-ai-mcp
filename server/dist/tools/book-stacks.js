 ...
 */
export async function listBookStacks() {
 ...
 */
export async function createBookStack(args) {
    const config = loadConfig();
    const err = requireCookie(config);
    if (err)
        return err;
 ...
 */
export async function updateBookStack(args) {
    const config = loadConfig();
    const err = requireCookie(config);
    if (err)
        return err;
 ...
 */
export async function sortBookStacks(args) {
    const config = loadConfig();
    const err = requireCookie(config);
    if (err)
        return err;
